...
# Vedha pentest worker image (Wayam AI). Derived from vxcontrol/kali-linux-image (MIT).
LABEL org.opencontainers.image.title="Vedha Kali Linux" \
      org.opencontainers.image.vendor="Wayam AI" \
      org.opencontainers.image.source="https://github.com/WayamAI/Vedha" \
      org.opencontainers.image.licenses="MIT"
ENV VEDHA_IMAGE=kali-linux
...
# Set working directory and branding
RUN mkdir -p /work && \
    echo "Vedha Kali Linux worker (Wayam AI) - https://github.com/WayamAI/Vedha" > /etc/motd
WORKDIR /work
