...
These Docker images serve as execution environments for AI agents in [Vedha](https://github.com/WayamAI/Vedha) - a fully autonomous AI agents system capable of performing complex penetration testing tasks. The AI agents interact with the containerized tools through command-line interfaces, enabling:
...
### Vedha Integration
These Docker images are designed to work seamlessly with [Vedha](https://github.com/WayamAI/Vedha), an autonomous AI agents system for penetration testing. The integration provides:
...
```bash
# Vedha spawns containers dynamically for isolated testing
...
docker exec vedha-terminal-123 nuclei -u https://target.com -o /results/vulns.json
```
...
For detailed integration examples and API documentation, visit the [Vedha repository](https://github.com/WayamAI/Vedha).
...
```bash
# Clone repository
git clone https://github.com/WayamAI/kali-linux.git
cd kali-linux
...
REGISTRY=wayamai  # Container registry (default: wayamai)
...
- [Vedha - Autonomous AI Penetration Testing](https://github.com/WayamAI/Vedha) - Primary use case for these Docker images
...
Contact Wayam AI at tech@wayam.ai, or:
